...
export default async function DashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Real-time v17.19 OIE tracking — kill zones, H4 bias, P&D zones, guardian confluence.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between"><span className="text-zinc-500">Pine Script</span><span className="font-mono text-emerald-400">v17.19</span></div>
      ...
      {/* Decode Reference */}
      <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
        <h3 className="text-sm font-semibold text-zinc-400 uppercase tracking-wider mb-4">v17.19 Decode Reference</h3>
