      ...
      <body className={`${inter.className} bg-zinc-950 text-zinc-100 min-h-screen`}>
          ...
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-semibold text-lg">
                TradeX OIE <span className="text-emerald-400 font-mono text-sm ml-1">v17.25</span>
              </span>
            </Link>
        ...
        <footer className="border-t border-zinc-800 mt-16">
          <div className="mx-auto max-w-7xl flex items-center justify-between px-4 py-6 text-sm text-zinc-500">
            <span>TradeX OIE <span className="font-mono text-zinc-300">v17.25</span></span>
